    ...
    return (
      <>
        ...
        <div className="flex gap-1 w-2/3">
          ...
          />
          <div
            className={`flex flex-col z-20 max-w-fit px-2 pt-2 rounded-md shadow-md relative ${bgClass}`}
          >
  ...
  return (
    <>
      ...
      <div className="flex gap-1 w-2/3 ml-auto">
        <div
          className={`flex z-20 max-w-fit px-2 pt-2 rounded-md ml-auto shadow-md relative ${bgClass}`}
        >
